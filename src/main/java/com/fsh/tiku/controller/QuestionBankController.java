...
import com.fsh.tiku.model.dto.questionBank.QuestionBankEditRequest;
import com.fsh.tiku.model.dto.questionBank.QuestionBankQueryRequest;
import com.fsh.tiku.model.dto.questionBank.QuestionBankUpdateRequest;
...
public class QuestionBankController {
    ...
    public BaseResponse<QuestionBankVO> getQuestionBankVOById(QuestionBankQueryRequest questionBankQueryRequest, HttpServletRequest request) {
        ...
        if(questionBankQueryRequest.isNeedQueryQuestionList()){
            ...
            Page<Question> questionVOPage = questionService.listQuestionByPage(questionQueryRequest);
            questionBankVO.setQuestionPage(questionVOPage);
        }

        //只有当key为热key的时候，才会进行set，所以第十次的时候不会进行set
